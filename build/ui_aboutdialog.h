...
public:
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About VeganCoin", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>VeganCoin</b> version", 0));
...
"Copyright \302\251 2018 The VeganCoin developers", 0));
