...
const string strMessageMagic = "VeganCoin Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "VeganCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (fTestNet)
    {
        ...
        bnTrustedModulus.SetHex("04dd9e82ad5d64acb53ade0f27cb67a750c214e8deb6c6a52b5cf93efb74be5a54c5b59bf6ef63b89a11d78afaa86818eb2436e8241ad9086df24d06b880a5d351");
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "day 3 of the world cup 2018";
        CTransaction txNew;
        txNew.nTime = 1529142771;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1529142771;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 276678 : 276678;
        ...
        assert(block.hashMerkleRoot == uint256("0xb8daf0007adec900fb734e417f45ee2953b56dd3dfd29b7f12cb5d5975df904a"));
